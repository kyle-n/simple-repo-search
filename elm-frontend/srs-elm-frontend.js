...
var $author$project$SimpleRepoSearch$initialModel = {direction: $author$project$Types$Desc, isLoading: false, query: '', results: _List_Nil, sort: $author$project$Types$Score};
var $author$project$SimpleRepoSearch$init = function (flags) {
	return _Utils_Tuple2($author$project$SimpleRepoSearch$initialModel, $elm$core$Platform$Cmd$none);
};
...
var $author$project$Types$SetResults = function (a) {
	return {$: 'SetResults', a: a};
};
...
var $author$project$Types$GitHubResponse = F3(
	function (totalCount, incompleteResults, items) {
		return {incompleteResults: incompleteResults, items: items, totalCount: totalCount};
	});
...
var $author$project$Api$githubDecoder = A2(
	...
	A3(
		...
		A3(
			...
			'total_count',
			$elm$json$Json$Decode$int,
			$elm$json$Json$Decode$succeed($author$project$Types$GitHubResponse))));
...
var $author$project$Api$searchRepos = function (query) {
	var apiUrl = A2(
	...
	return $elm$http$Http$get(
		{
			expect: A2($elm$http$Http$expectJson, $author$project$Types$SetResults, $author$project$Api$githubDecoder),
			url: apiUrl
		});
};
...
var $author$project$SimpleRepoSearch$updateResults = F2(
	function (model, resp) {
		if (resp.$ === 'Ok') {
			var ghResp = resp.a;
			return _Utils_Tuple2(
...
var $author$project$SimpleRepoSearch$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'SetQuery':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{query: newQuery}),
					$author$project$Api$searchRepos(newQuery));
			...
			default:
				var resp = msg.a;
				return A2($author$project$SimpleRepoSearch$updateResults, model, resp);
		}
	});
...
var $author$project$Types$emptyHtml = $elm$html$Html$text('');
...
var $author$project$Results$Card$viewOwnerAvatar = F2(
	function (url, login) {
		if (url.$ === 'Just') {
			var avatarUrl = url.a;
			return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($author$project$Results$Card$viewOwnerAvatar, repo.owner.avatarUrl, repo.owner.login)
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('col s2 l1'),
								$elm$html$Html$Attributes$class('offset-s4 offset-l5'),
								A2($elm$html$Html$Attributes$style, 'display', 'flex'),
								A2($elm$html$Html$Attributes$style, 'flex-direction', 'column'),
								A2($elm$html$Html$Attributes$style, 'align-items', 'center')
							]),
...
var $author$project$Results$Card$viewUpdatedAt = function (time) {
	if (time.$ === 'Just') {
		var updatedAt = time.a;
		return A2(
			$elm$html$Html$p,
			_List_Nil,
			_List_fromArray(
				[
					$elm$html$Html$text(
					'Updated at: ' + $author$project$Types$posixToFormattedDate(updatedAt))
				]));
	} else {
		return $author$project$Types$emptyHtml;
	}
...
var $author$project$Results$Card$viewCardContent = function (repo) {
	return _List_fromArray(
		[
			...
			$author$project$Results$Card$viewUpdatedAt(repo.updatedAt)
		]);
};
...
var $author$project$Types$SetSort = function (a) {
	return {$: 'SetSort', a: a};
};
...
var $author$project$Types$stringToSort = function (str) {
	var _v0 = $elm$core$String$toLower(str);
	switch (_v0) {
		case 'stars':
			return $author$project$Types$Stars;
		case 'updated':
			return $author$project$Types$Updated;
		default:
			return $author$project$Types$Score;
	}
};
var $elm$html$Html$option = _VirtualDom_node('option');
var $author$project$Input$Filters$viewSortFilterOption = function (sort) {
	var sortString = $author$project$Types$sortToString(sort);
	return A2(
		$elm$html$Html$option,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$value(sortString)
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(sortString)
			]));
};
...
_Platform_export({'SimpleRepoSearch':{'init':$author$project$SimpleRepoSearch$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Types.Msg","aliases":{"Types.GitHubResponse":{"args":[],"type":"{ totalCount : Basics.Int, incompleteResults : Basics.Bool, items : List.List Types.Repo }"},"Types.Owner":{"args":[],"type":"{ avatarUrl : Maybe.Maybe String.String, htmlUrl : String.String, login : String.String }"},"Types.Repo":{"args":[],"type":"{ archived : Basics.Bool, createdAt : Time.Posix, description : String.String, htmlUrl : String.String, id : Basics.Int, name : String.String, owner : Types.Owner, score : Basics.Float, stars : Basics.Int, updatedAt : Maybe.Maybe Time.Posix }"}},"unions":{"Types.Msg":{"args":[],"tags":{"SetQuery":["String.String"],"ToggleDirection":[],"SetSort":["Types.Sort"],"SetResults":["Result.Result Http.Error Types.GitHubResponse"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Types.Sort":{"args":[],"tags":{"Score":[],"Stars":[],"Updated":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));